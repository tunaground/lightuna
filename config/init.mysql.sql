create or replace table seq_thread_uid (sequence bigint(0) auto_increment primary key);
--
create or replace table seq_response_uid (sequence bigint(0) auto_increment primary key);
--
create or replace table seq_arc_thread_uid (sequence bigint(0) auto_increment primary key);
--
create or replace table seq_arc_response_uid (sequence bigint(0) auto_increment primary key);
--
